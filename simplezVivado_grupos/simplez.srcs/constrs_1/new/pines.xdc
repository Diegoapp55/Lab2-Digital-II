...
#Switch
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { sw2 }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { dtr }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { stop }]; #IO_L22P_T3_A05_D21_14 Sch=led[10]
